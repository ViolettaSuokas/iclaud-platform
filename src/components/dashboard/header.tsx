      ...
      <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-white/[0.06] bg-background/80 px-6 backdrop-blur-xl">
        <div className="flex items-center gap-4 flex-1">
          ...
          <button
            ...
            className="flex items-center gap-3 h-9 px-4 rounded-md bg-white/[0.03] border border-white/[0.06] text-muted-foreground hover:bg-white/[0.05] hover:border-white/[0.1] transition-all max-w-sm flex-1"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          {user.credits !== undefined && (
            <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-[#ffcc00]/10 border border-[#ffcc00]/20">
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                <Avatar className="h-8 w-8 rounded-md">
                  <AvatarFallback className="rounded-md bg-gradient-to-br from-[#00d4ff] to-[#00ff88] text-[#05050a] text-xs font-bold">
                    {initials}
                  </AvatarFallback>
                </Avatar>
              </Button>
